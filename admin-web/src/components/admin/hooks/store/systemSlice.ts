      ...
      try {
        await request<{ ok: boolean }>("/admin/api/config/runtime", {
          ...
          body: JSON.stringify({
            ...
            llmMemoryContextEnabled: get().runtimeDraft.llmMemoryContextEnabled,
            memoryCompactEveryRounds: get().runtimeDraft.memoryCompactEveryRounds.trim(),
            memoryCompactMaxBatchSize: get().runtimeDraft.memoryCompactMaxBatchSize.trim(),
            memorySummaryTopK: get().runtimeDraft.memorySummaryTopK.trim(),
            memoryRawRefLimit: get().runtimeDraft.memoryRawRefLimit.trim(),
            memoryRawRecordLimit: get().runtimeDraft.memoryRawRecordLimit.trim(),
