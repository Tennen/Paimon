...
type SystemSectionProps = {
  ...
  onCodexDraftChange: <K extends keyof SystemCodexDraft>(key: K, value: SystemCodexDraft[K]) => void;
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-3 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                value={props.codexDraft.model}
                onChange={(event) => props.onCodexDraftChange("model", event.target.value)}
            ...
            <div className="space-y-2">
              ...
              <Select
                value={props.codexDraft.reasoningEffort || "__empty__"}
                onValueChange={(value) => props.onCodexDraftChange("reasoningEffort", value === "__empty__" ? "" : value)}
              >
                <SelectTrigger>
          ...
          <div className="flex flex-wrap gap-2">
            <Button type="button" variant="secondary" disabled={props.operationState.savingCodexConfig} onClick={props.onSaveCodexConfig}>
              {props.operationState.savingCodexConfig ? "保存中..." : "保存 Codex 配置"}
            </Button>
          </div>
        </CardContent>
      </Card>
