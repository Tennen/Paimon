...
export const DATA_STORE = {
  ...
  MEMORY_CONVERSATION_WINDOWS: "memory.conversation_windows",
  AUDIT_LOG: "audit.log",
...
const STORE_FILE_MAP: Record<DataStoreName, string> = {
  ...
  [DATA_STORE.CONVERSATION_CONTEXT]: "conversation/context.json",
  ...
  [DATA_STORE.MEMORY_CONVERSATION_WINDOWS]: "memory/conversation-windows.json",
...
const STORE_DEFAULT_CODEC_MAP: Record<DataStoreName, DataStoreCodec> = {
  ...
  [DATA_STORE.CONVERSATION_CONTEXT]: "json",
  ...
  [DATA_STORE.MEMORY_CONVERSATION_WINDOWS]: "json",
